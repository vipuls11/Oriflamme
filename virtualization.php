...
<div class="container mx-auto w-full relative opacity-80">
        ...
        <div class="absolute top-80 left-5 lg:block hidden">
            ...
            <div class="flex gap-4 px-4 items-center my-10 opacity-95 bg-slate-50 py-4 text-center text-xl font-semibold text-center justify-center">
                ...
                <h2><a href="aboutus.php">Virtualization</a></h2>
            </div>
        </div>
...
<div class="container mx-auto">
    <div class="flex">
        ...
        <div class="my-10 px-8">
           <h3 class="text-4xl font-semibold">Accelerate your virtualization with <span class="text-sky-950">Oriflamme It Solutions</span>.</h3>    
           <p class="leading-8 my-5">Our industry-leading servers, storage devices, and data management solutions are designed to help organizations across industries achieve their virtualization goals faster and more efficiently. Trust <span class="text-sky-950">Oriflamme IT Solutions</span> to help you streamline your IT infrastructure and improve overall performance.</p><br>
           <p class="leading-8 ">Ongoing support to keep your organization ahead of the game.</p>

           <div class=" my-5">
            <h3 class="text-xl font-semibold mb-5 capitalize">VIRTUALIZE YOUR IT INFRASTRUCTURE WITH EASE.</h3>
            <p class="leading-8">Say goodbye to the limitations of physical hardware and hello to a more efficient, streamlined IT system. With <span class="text-sky-950">Oriflamme IT Solutions</span>, you can easily simulate hardware functionality and create a virtual computer system that meets your specific needs. Accelerate your virtualization process and stay ahead of the competition.</p>
           ...
           <div class=" my-5">
            <h3 class="text-xl font-semibold mb-5 capitalize">LET’S SEE HOW VIRTUALIZATION WORKS</h3>
            <p class="leading-8">Virtual Machine Monitor (VMM), the software layer, can be deployed over the host operating system or right onto the system hardware. The virtualization architecture of the server is dependent on how VMM is installed. It makes it possible to transition between virtual machines without restarting or hardware partitioning.</p>
           ...
           <div class=" my-5  py-5 bg-gray-50">
            ...
            <div class="grid grid-cols-3 gap-5"> 
                ...
                <div class="text-center border border-gray-300 px-4 shadow-xl text-white rounded-xl bg-sky-950">
                        <img src="img/virtual-reality-removebg-preview.png" alt="" class="w-24 h-24 mx-auto my-4">
                ...
                <div class="text-center border border-gray-300 px-4 shadow-xl text-white rounded-xl bg-sky-950">
                        <img src="img/network-removebg-preview.png" alt="" class="w-24 h-24 mx-auto my-4">
