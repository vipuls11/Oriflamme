...
<body>
    ...
    <div class="container mx-auto my-10">
        <div class="grid lg:grid-cols-2 gap-5 place-content-center">
            <div>
                <h4 class="uppercase text-sm text-red-600 font-semibold mb-4">About Us</h4>
                <h1 class="text-4xl text-sky-950 font-semibold my-5">We’re Delivering The Best Customer Experience</h1>
                <div class="lg:flex ">
    ...
    <div>
        <div class="grid grid-cols-2  my-10">
            <div class="w-full"><img src="img/whyuseyou.jpg" alt="" class="w-full mt-14"></div>
            <div class="bg-sky-950 bg-[url('img/bg-07.png')] bg-cover bg-no-repeat grid place-content-center">
                <div class="px-8  ">
                    ...
                    <h1 class="text-4xl text-white font-semibold ">We are building a sustainable future</h1>
                    <p class="my-5 leading-8 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto dolorum qui quidem quis accusantium reprehenderit laboriosam natus voluptatem deleniti voluptas perferendis, dignissimos repellat distinctio cupiditate atque minus excepturi ad ipsam.</p>
                    <div class="grid grid-cols-3 text-white">
                        <div>
                            <img src="img/icon-web-development.png" alt="" class="w-16 h-16">
    ...
    <div class="">
        <div class="text-center">
            <h4 class="uppercase text-sm text-red-600 font-semibold mb-5">WHY CHOOSE US</h4>
            <h1 class="text-4xl text-sky-950 font-semibold mb-10 ">Our Working Process</h1>
            <div class="grid grid-cols-3 px-10 gap-10 justify-items-center bg-[url('img/process-line.png')] bg-no-repeat bg-center">
                <div class="card_wrapper text-center px-4 hover:scale-110">
                    ...
                    <h2 class="text-xl font-semibold text-sky-950 my-2">Design</h2>
                    <p class="text-sm leading-8">We focus on the best practices for it solutions and services.</p>
                </div>
    ...
    <div class="text-center my-10">
        <h4 class="uppercase text-sm text-red-600 font-semibold my-5">About Us</h4>
        <h1 class="text-4xl text-sky-950 font-semibold my-5">Our Motivated Team</h1>
...
<!-- .................................................core team.......................... -->
        <h1 class="text-4xl text-sky-950 font-semibold my-5">Core Motivated Team</h1>
        <div class="grid grid-cols-4 gap-5  w-10/12 mx-auto">
            <div>
                <div class="relative"><img src="img/team-01.jpg" alt="" class="">
                    <div class="image_card  absolute top-0 right-0 bottom-0 left-0 text-end w-full h-full bg-cover overflow-hidden opacity-0 transition duration-300 ease-in-out bg-sky-950 hover:opacity-60">
    ...
    <div class="container mx-auto my-10">
        <div class="text-center">
            <h4 class="uppercase text-sm text-red-600 font-semibold mb-5">FAQ</h4>
            <h1 class="text-4xl text-sky-950 font-semibold mb-10 ">Do You Have Any Questions?</h1>
        </div>
