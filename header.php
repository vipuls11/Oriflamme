...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="tailwin img/logo1.png" width="">
        <!-- ----------jquery--------- -->
           ...
           <li class="menu relative "><a href="itservices.php"  class="py-2 mx-4 <?php echo(basename($_SERVER['PHP_SELF'])=="itservices.php"?"active2":"")?>">IT SERVICES</a>
            <div class="sub-menu-it-services absolute hidden text-left top-[32px] left-5 bg-sky-950 px-2 text-white text-sm w-60">
                <ul>
                   ...
                   <li class="mb-2 py-2"><a  href="" class=" <?php echo(basename($_SERVER['PHP_SELF'])==""?"active2":"")?>">NETWORKING SOLUTIONS</a></li>
                   ...
                   <li class="mb-2 py-2"><a   href="">NETWORK SECURITY</a> </li>
                   ...
                   <li  class="mb-2 py-2"><a   href="">BACKUP & DISASTER RECOVERY</a></li>
            ...
            <li class=" menu relative  "><a href=""  class="py-2 mx-4">SURVEILLANCE SERVICES</i></a>
                <div class="Sub-Menu absolute hidden text-left top-[32px] left-5 bg-sky-950 text-white px-2 py-2 text-sm  w-60">
                    <ul>
                    <li class="mb-2 py-2"><a  href="">VIDEO SURVEILLANCE</a></li>
                     ...
                     <li class="mb-2 py-2"><a  href="">ATTENDANCE SOLUTIONS</a></li> 
                    <li class="mb-2 py-2"><a   href="">INTRUSION ALARM</a></li> 
                </ul>
                 </div>
             </li>
